...
### Week 7 Objectives:
* Get familiar with Amazon DynamoDB NoSQL database, practice data manipulation, and cost analysis.
* Explore DynamoDB Zero-ETL integrations.
...
* Proficiently practiced basic operations (Create, Read, Update, Query) and advanced indexing techniques (Global Secondary Index) on DynamoDB.
* Successfully integrated applications with the database using the AWS SDK (Boto3) in Python.
* Explored modern Zero-ETL technology, directly connecting data from DynamoDB to OpenSearch Service and Amazon Bedrock for AI-powered search applications.
