...
### Mục tiêu tuần 5:
* Tìm hiểu các tiêu chuẩn bảo mật và quản lý tài nguyên trên AWS thông qua Security Hub, Tagging, Resource Groups và IAM.
...
* Biết cách phân loại và quản lý hàng loạt tài nguyên thông qua chiến lược AWS Tagging và Resource Groups một cách khoa học.
* Củng cố kiến thức về IAM bằng cách thực hành áp dụng nguyên tắc quyền tối thiểu (least privilege) trong thực tế phân quyền.
* Tích hợp tự động hóa vào quy trình quản trị tài nguyên bằng cách viết Lambda Function xử lý tự động gắn tag cho EC2 Instance.
